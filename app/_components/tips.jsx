                ...
                <div className="flex flex-wrap w-2/5 p-4 bg-gray-100 rounded-md drop-shadow-md">
                    <div className="grid gap-4 w-full">
                        ...
                        <div className="flex justify-between gap-1">
                            {
                                data && data?.historialLaboral.map((item, index) => {
                                    return (
                                        <p
                                            key={index}
                                            onClick={() => handleDateClick(index)}
                                            className={`font-semibold inline-flex items-center px-4 py-2 rounded-full ${selectedDate === item
                        ...
                        <div className="flex bg-white p-3 rounded-sm">
                            ...
                            <p className="font-semibold ml-auto">{selectedDate?.salarioBaseCotizacion}</p>
                        </div>
                ...
                <div className="flex flex-wrap w-3/5 p-4 bg-gray-100 rounded-md drop-shadow-md">
                    <div className="grid gap-4 w-full">
                        ...
                        <div className="flex bg-white p-3 rounded-sm items-center">
                            ...
                            <p className="font-semibold ml-auto text-end">{selectedDate?.nombrePatron}</p>
                        </div>
