...
export default function Page() {
  ...
  const handleSubmit = async () => {
    router.push('/notificacion'); // Redirecciona a la página de notificación
  };
  ...
  return (
    <main className="bg-gray-200">
      <section className="p-6">
        ...
        {/* STEPS */}
        <div className="flex w-full justify-around my-10 relative items-center">
          <div className="grid justify-items-center gap-1 z-10">
            ...
            <p className="text-blue-600 text-sm font-medium">Datos Bancarios</p>
          </div>
          <div className="grid justify-items-center gap-1 z-10">
            <div
          ...
          <div className="absolute left-1 right-1 h-1 bg-blue-400 sm:top-10 top-6"></div>
        </div>
          ...
          {currentPage == 1 && (
            <div className="my-4 flex gap-6 flex-wrap">
              ...
              <div className="items-center grid gap-6 w-full p-4 bg-white rounded-md drop-shadow-md">
                <div>
                  <label htmlFor="payAmount">Banco:</label>
                ...
                <div>
                  <label htmlFor="paymentMethod">Cuenta o CLABE:</label>
                  <div className="relative">
                    <input
                      className="w-full py-2 border-b text-blue-700 border-gray-300 focus:outline-none focus:border-indigo-500"
                      type="string"
          ...
          {currentPage == 2 && (
            <div className="items-center grid gap-6 w-full p-4 bg-white rounded-md drop-shadow-md">
              <div className="flex justify-between">
                <p className="text-lg">Total a Domiciliar:</p>
                <p className=" text-blue-700 font-semibold text-lg">$299.00</p>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4 ">
                ...
                <p class="text-left text-blue-700 font-medium">55 2759 5659</p>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4 ">
                <p>Banco:</p>
                <p class="text-left text-blue-700 font-medium">{payAmount}</p>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4 ">
                ...
                <select
                  id="tipo"
                  name="tipo"
                  class="block w-full border border-gray-300 rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <p>
                Al confirmar serás transferido a la app de tu banco para
                realizar tu domicilación
              </p>
            </div>
          )}
        </form>
